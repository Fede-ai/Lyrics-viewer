...
HRESULT Recorder::finishWaveFile(HMMIO hFile, MMCKINFO* pckRIFF, MMCKINFO* pckData) {
    MMRESULT result;
...
HRESULT Recorder::copyData(BYTE* pData, UINT32 NumFrames, WAVEFORMATEX* pwfx, HMMIO hFile)
{
    HRESULT hr = S_OK;
    ...
    std::cout << "callCount = " << callCount++ << ", numFrames: " << NumFrames << "\n";
